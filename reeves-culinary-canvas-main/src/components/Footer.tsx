      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>123 Beach Road, Kakinada</p>
              <p>+91 9876543210</p>
              <p>hello@reeveskakinada.com</p>
            </div>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © 2024 Reeves Restaurant, Kakinada. All rights reserved. |
          </p>
          <a
            href="https://elitedigitalsolutions.tech"
            target="_blank"
            rel="noopener noreferrer"
            className="block mt-3 text-xs sm:text-sm text-muted-foreground hover:text-primary transition-colors underline underline-offset-2"
          >
            Developed by elitedigitalsolutions.tech
          </a>
        </div>
      </div>
    </footer>
